...
const SIGNUP_SYSTEM_PROMPT = `You are Sage, the friendly Care Compass guide. The user is on the sign-up page creating a new account. Help them understand what Care Compass is, what to expect when they sign up, how their data is kept private, and what they'll get access to. Be warm, encouraging, and concise — 2-3 sentences max. No bullet points or markdown.`;

const SIGNUP_SUGGESTIONS = [
    ...
    <>
      ...
      {greeting && !open && (
        <div style={ss.greeting}>
          <p style={ss.greetingText}>Hi, I'm Sage! Have questions before you sign up? I'm happy to help.</p>
      ...
      {open && (
        <div style={ss.drawer}>
          ...
          <div style={ss.messages}>
            {messages.length === 0 && (
              <div>
                <div style={ss.emptyState}>Questions before you get started? I'm here!</div>
                <div style={ss.suggestedWrap}>
                  {SIGNUP_SUGGESTIONS.map(q => (
